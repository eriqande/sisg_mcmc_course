...
To see what these files look like, use the Windows file browser to find and open the two files in the PlainPars directory in your {\em structure} project folder:
\begin{center}
